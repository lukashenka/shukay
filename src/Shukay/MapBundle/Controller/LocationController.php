...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShukayMapBundle:Location')->findAll();
     ...
     * @Method("POST")
     * @Template("ShukayMapBundle:Location:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShukayMapBundle:Location')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ShukayMapBundle:Location:edit.html.twig")
     */
